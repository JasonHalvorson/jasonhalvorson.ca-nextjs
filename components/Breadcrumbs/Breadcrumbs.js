            ...
            <ol role="list" className="max-w-screen-xl w-full mx-auto px-4 flex space-x-4 sm:px-6 lg:px-8">
                <li className="flex">
                    <div className="flex items-center">
                        <Link href="/">
                            <a className="text-gray-400 hover:text-jhpurple transition-colors duration-300">
                ...
                {getSlug().map((slugObject) => (
                    <li key={slugObject.fullSlug} className="flex">
                        <div className="flex items-center">
                            ...
                            <Link href={`${slugObject.fullSlug}`}>
                                <a className="ml-4 text-sm font-medium dark:text-gray-400 text-gray-500 hover:text-jhpurple dark:hover:text-jhpurple transition-colors duration-300 capitalize">{slugObject.slug}</a>
                            </Link>
                        </div>
                    </li>
                ))}
